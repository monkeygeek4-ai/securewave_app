...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  Future<void> _refreshMessages() async {
    ...
    try {
      ...
      print(
          '[ChatScreen] 🔄 Автообновление: текущее количество сообщений: $oldCount');
      ...
      if (newCount > oldCount) {
        ...
        print('[ChatScreen] ⚪ Новых сообщений нет ($newCount)');
      }
    } catch (e) {
  ...
  Future<void> _loadMessages() async {
    ...
    print(
        '[ChatScreen] ✅ Первоначальная загрузка завершена: ${chatProvider.messages.length} сообщений');
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      print(
          '[ChatScreen] ✅ Сообщение отправлено, принудительно обновляем список');
                ...
                child: Consumer<ChatProvider>(
                  builder: (context, chatProvider, _) {
                    ...
                    if (messages.length > _previousMessageCount &&
                      ...
                      print(
                          '[ChatScreen] 📜 Обнаружено новое сообщение в UI, прокручиваем вниз');
                      WidgetsBinding.instance.addPostFrameCallback((_) {
